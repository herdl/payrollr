...
class ReportsGroup extends BaseGroup
{
     ...
     * PAPDIS is a free and open data interface standard designed to allow payroll and middleware software developers
     * to create a file that can be used by pension providers to exchange data. http://www.papdis.org
     *
     * @param string $employerKey
     * @param string $payScheduleKey
     * @param string $taxYear
     ...
     * PASS 1.1 is an extension of the PAPDIS V1.1 schema.
     * https://pensionsynckb.systemsyncsolutions.com/display/PKB/PASS+1.1
     *
     * @param string $employerKey
     * @param string $payScheduleKey
     * @param string $taxYear
     ...
     * See https://api.paydashboard.com for details. For compatibility should be returned as JSON with
     * TransformDefinitionKey=Json-Clean.
     *
     * @param string $employerKey
     * @param string $payScheduleKey
     * @param string $taxYear
